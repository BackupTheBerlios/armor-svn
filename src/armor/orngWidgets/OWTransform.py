...
class OWTransform(OWWidget):
    ...
    def applySettings(self):
        if self.transform:
            ...
            if armor.applySettings(self.settingsList, self, obj=self.transform, outputSlot=self.transform.outputSlot):
                self.sendData()
    ...
    def setLabels(self, slot):
        ...
        if self.transform is None:
            self.transform = armor.transforms.Transform(transtype=self.transtypes[self.transidx],
