"""
<name>SIFT</name>
<description>SIFT feature extractor/classifier.</description>
<icon>icons/-.png</icon>
<contact>Ales Erjavec (ales.erjavec(@at@)fri.uni-lj.si)</contact>
<priority>100</priority>
"""
import orngOrangeFoldersQt4
import orange, OWGUI, sys, sift
from OWWidget import *
from exceptions import SystemExit

class OWsift(OWWidget):
    settingsList=["octave", "levels", "firstoctave", "frames", 
                             "peakthresh", "edgethresh", "orientations", "verbose"]
    def __init__(self, parent=None, signalManager=None, name="SIFT"):
        ...
        self.outputs=[("Descriptors", ExampleTable, self.setData), ("Frames", ExampleTable, self.setData)]
        ...
        self.data = None
        self.selFlag=False
        self.name="SIFT Feature Extractor"
